...
class Coupling(Initialization):
    ...
    class Calculate:
        ...
        def RatioOfSuppression(self, suppressed_values: list):
        ...
        def RatioOfExcitation(self, excited_values: list):
            ...
            ratio_of_excitation = np.abs(avg_change_exc_weight) / np.abs(avg_magnitude_exc_weight)
            return ratio_of_excitation
...
# c = Coupling('DIV66.txt', delimiter='\t', coupling_enhance_factor=2)
# c_calc = c.calculate
# c_plot = c.plot

# c_calc.AverageSynapticWeight_ExcitatoryIncomingLinks(23)
# c_calc.AverageSynapticWeight_InhibitoryIncomingLinks(0)
# c_calc.AverageSynapticWeight_OutgoingLinks(23)
...
# output_name = 'Network_C_Info.txt'

# with open(output_name, 'w') as fp:
#     fp.write('Minimum coupling weight: {}, Maximum: {}\n'.format(coupling_bound[0], coupling_bound[1]))
#     fp.write('Connection probability: {}\n'.format(connection_probability))
#     fp.write('Mean of coupling weight: {}\n'.format(coupling_stat[0]))
#     fp.write('SD of coupling weight: {}\n'.format(coupling_stat[1]))
#     fp.write('Mean of excitatory node weight: {}\n'.format(coupling_stat[0]))
#     fp.write('SD of excitatory node weight: {}\n'.format(exc_node_stat[1]))
#     fp.write('Mean of inhibitory node weight: {}\n'.format(inh_node_stat[0]))
#     fp.write('SD of inhibitory node weight: {}'.format(inh_node_stat[1]))