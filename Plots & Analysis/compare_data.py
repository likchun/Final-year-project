...
# sc = Compare(spiking_data, data_info, input_folder[0]+'\\INI_CNFG')
# sc = Compare(spiking_data, data_info, input_folder[0]+'\\INI_CNFG', simulataion_duration_override=[7500, 10000, 15000])
# sc_calc = sc.calculate
# sc_plot = sc.plot
